  ...
  return (
    <div>
      ...
      <main className={styles.container}>
        ...
        <a className={styles.link} href='arvostelu.jpg' rel='prefetch'>Lue kirja-arvostelu</a>
        <a className={styles.link} href='https://www.adlibris.com/fi/kirja/pajan-hamarasta-9789529342501' rel='external crossorigin prefetch'>Osta Adlibris-verkkokirjakaupasta</a>
