...
export default class Index extends Component {
  ...
  render () {
    ...
    const microdata = {
      ...
      'jobTitle': 'taiteilija',
      'jobTitle': 'kultaseppä',
      'jobTitle': 'korutaiteilija',
      'jobTitle': 'heraldikko',
      'jobTitle': 'lavastaja',
      'jobTitle': 'kansainvälisen taiteilijavaihdon tuottaja',
      'jobTitle': 'rautakautisten menetelmien tutkija',
      'jobTitle': 'tietokirjailija',
      'url': config.siteUrl,
      ...
      'alumniOf': 'Lahden kultaseppäkoulu',
      'alumniOf': 'Taideteollinen korkeakoulu',
      'alumniOf': 'Tampereen yliopisto',
        ...
        <main>
          <section className="about">
            ...
            <ul className="projects">
              <li>
                <a href="/pajanhamarasta/" rel="prefetch">
              ...
              <li typeof="Book">
                <a href="/ikuisetseprat/" rel="prefetch">
