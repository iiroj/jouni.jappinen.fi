            ...
            <ul css={articlesStyles}>
                <li>
                    <a href="/viirankosken-vyokoukku.pdf">
                        <article css={articleStyles}>
                            <figure alt="Viirankosken vyökoukku" css={viirankoski} role="img" />
                ...
                <li>
                    <a href="/rautakuona.pdf">
                        <article css={articleStyles}>
                            <figure alt="Kymijokisuiston rautakuona" css={rautakuona} role="img" />
                ...
                <li>
                    <a href="/tammijarvi.pdf">
                        <article css={articleStyles}>
                            <figure alt="Experimentel forskning vid Tammijärvi i Pyttis" css={tammijarvi} role="img" />
                ...
                <li>
                    <a href="/antti-jappinen.pdf">
                        <article css={articleStyles}>
                            <figure alt="Sotamies Antti Jäppinen" css={anttijappinen} role="img" />
