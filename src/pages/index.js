...
const minWidth = args => styleObject => ({ [`@media (min-width: ${args})`]: styleObject });
    ...
    <main className={mainStyles}>
      ...
      <footer>
        <nav>
          <ul>
            <li>
              <a className={linksStyles} href="/kirjoituksia.pdf">
                Kirjoituksia
              </a>
            </li>
            <li>
              <a className={linksStyles} href="mailto:Jouni Jäppinen <jouni@jappinen.fi>">
                Ota yhteyttä
              </a>
            </li>
            <li>
            ...
            <li>
              <a className={linksStyles} href="https://www.artists-o.fi" rel="external crossorigin prefetch">
                Taiteilijat O
              </a>
            </li>
          </ul>
